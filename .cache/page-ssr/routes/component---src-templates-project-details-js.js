...
var project_details_module_html = "project-details-module--html--56803";
var featured = "project-details-module--featured--b7e47";

;// CONCATENATED MODULE: ./src/templates/project-details.js
const ProjectDetails=({data})=>{const{html}=data.markdownRemark;const{title,stack,featuredImg}=data.markdownRemark.frontmatter;return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(Layout/* default */.Z,null,/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:details},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h2",null,title),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h3",null,stack),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:featured},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_image/* default */.Z,{fluid:featuredImg.childImageSharp.fluid})),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:project_details_module_html,dangerouslySetInnerHTML:{__html:html}})));};/* harmony default export */ const project_details = (ProjectDetails);const query="280977141";
