...
function Navbar(){const data=(0,gatsby_browser_entry.useStaticQuery)("3837623680");const{title}=data.site.siteMetadata;return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("nav",null,/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h1",null,title),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:"links"},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"Home"),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/about"},"About"),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/projects"},"Portfolio Projects")));}
;// CONCATENATED MODULE: ./src/components/Layout.js
function Layout({children}){return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:"layout"},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(Navbar,null),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:"content"},children),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("footer",null,/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("p",null,"Copyright 2021 Web Warrior")));}
...
const Projects=({data})=>{console.log(data);const projects=data.projects.nodes;const contact=data.contact.siteMetadata.contact;return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(Layout/* default */.Z,null,/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:portfolio},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h2",null,"Portfolio"),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h3",null,"Projects & Websites I've Created"),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",{className:projects_module_projects},projects.map(project=>/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/projects/"+project.frontmatter.slug,key:project.id},/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("div",null,/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(gatsby_image/* default */.Z,{fluid:project.frontmatter.thumb.childImageSharp.fluid}),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("h3",null,project.frontmatter.title),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("p",null,project.frontmatter.stack))))),/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement("p",null,"Likewhat you see? email me at ",contact," for a quote!")));};/* harmony default export */ const projects = (Projects);// export page query
