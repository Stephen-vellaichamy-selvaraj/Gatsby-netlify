...
var React = _interopRequireWildcard(__webpack_require__(5022));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(5022);
...
var _react = _interopRequireDefault(__webpack_require__(5022));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-about-js":()=>__webpack_require__.e(/* import() | component---src-pages-about-js */ 682).then(__webpack_require__.bind(__webpack_require__, 5465)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 9779)),"component---src-pages-projects-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-projects-index-js */ 216).then(__webpack_require__.bind(__webpack_require__, 7132)),"component---src-templates-project-details-js":()=>__webpack_require__.e(/* import() | component---src-templates-project-details-js */ 494).then(__webpack_require__.bind(__webpack_require__, 4745))};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5022);
...
// EXTERNAL MODULE: external "C:\\Development\\Contentful\\ABCDemo\\Gatsby-netlify\\node_modules\\react\\index.js"
var external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_ = __webpack_require__(5022);
var external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_);
// EXTERNAL MODULE: ./node_modules/@gatsbyjs/reach-router/dist/index.modern.mjs
var index_modern = __webpack_require__(7896);
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// CONCATENATED MODULE: ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
...
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Development_Contentful_ABCDemo_Gatsby_netlify_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
...
const React=__webpack_require__(5022);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(5093);const{parse}=__webpack_require__(698);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(5022),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("C:\\Development\\Contentful\\ABCDemo\\Gatsby-netlify\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Development\\Contentful\\ABCDemo\\Gatsby-netlify\\node_modules\\react-dom\\server.js");
...
/******/ 			return "" + {"216":"component---src-pages-projects-index-js","494":"component---src-templates-project-details-js","678":"component---src-pages-index-js","682":"component---src-pages-about-js","883":"component---src-pages-404-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
